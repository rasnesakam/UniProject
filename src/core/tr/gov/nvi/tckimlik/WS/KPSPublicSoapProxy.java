...
public class KPSPublicSoapProxy implements core.tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  private String _endpoint = null;
  private core.tr.gov.nvi.tckimlik.WS.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new core.tr.gov.nvi.tckimlik.WS.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public core.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
